  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved group as @group" do
        ...
        post :create, {:group => { "user_type_id" => "invalid value" }}, valid_session
        assigns(:group).should be_a_new(Group)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested group" do
        ...
        Group.any_instance.should_receive(:update_attributes).with({ "user_type_id" => "1" })
        put :update, {:id => group.to_param, :group => { "user_type_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the group as @group" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Group.any_instance.stub(:save).and_return(false)
        put :update, {:id => group.to_param, :group => { "user_type_id" => "invalid value" }}, valid_session
        assigns(:group).should eq(group)
      end
