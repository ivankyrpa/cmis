  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved operation as @operation" do
        ...
        post :create, {:operation => { "name" => "invalid value" }}, valid_session
        assigns(:operation).should be_a_new(Operation)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested operation" do
        ...
        Operation.any_instance.should_receive(:update_attributes).with({ "name" => "MyString" })
        put :update, {:id => operation.to_param, :operation => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the operation as @operation" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Operation.any_instance.stub(:save).and_return(false)
        put :update, {:id => operation.to_param, :operation => { "name" => "invalid value" }}, valid_session
        assigns(:operation).should eq(operation)
      end
