...
describe "f_recommendations/edit" do
  before(:each) do
  ...
  it "renders the edit f_recommendation form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => f_recommendations_path(@f_recommendation), :method => "post" do
