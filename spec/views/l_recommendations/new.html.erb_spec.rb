...
describe "l_recommendations/new" do
  before(:each) do
    assign(:l_recommendation, stub_model(LRecommendation,
      :group_id => 1,
      :content_o => "MyText",
      :content_c => "MyText",
      :content_d => "MyText",
  ...
  it "renders new l_recommendation form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => l_recommendations_path, :method => "post" do
