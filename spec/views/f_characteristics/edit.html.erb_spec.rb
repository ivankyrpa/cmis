...
describe "f_characteristics/edit" do
  before(:each) do
  ...
  it "renders the edit f_characteristic form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => f_characteristics_path(@f_characteristic), :method => "post" do
